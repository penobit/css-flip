...
class CSSFlip {
	...
	private static function buildPatterns() {
		...
		// <https://github.com/CSSFlip/php-CSSFlip/issues/14>, <https://phabricator.wikimedia.org/T215746#4944830>.
	 ...
	 * these problems.
	 *
	 * See https://code.google.com/p/CSSFlip/issues/detail?id=15
	 *
	 * @param $css string
	 * @return string
	 */
	 ...
	 * See https://code.google.com/p/CSSFlip/issues/detail?id=16
	 * @param $css string
	 * @return string
	 */
